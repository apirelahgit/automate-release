...
-  **Nota**: #0969DA El estándar "Obligatorio" del encoding cuando existen caracteres especiales deberá ser ISO-8859-1 (con excepción de los archivos .XML que el encoding deberá ser UTF-8)
